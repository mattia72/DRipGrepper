...
type
  ...
  TOptionsHelper = record
    ...
    public
      ...
      class function GetOptionValueFromOptions(const _sOptions, _sOptionRegex :
          string; var _sValue : string): Boolean; static;
...
class function TOptionsHelper.GetOptionValueFromOptions(const _sOptions,
    _sOptionRegex : string; var _sValue : string): Boolean;
var
