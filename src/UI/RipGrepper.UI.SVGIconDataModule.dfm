    ...
    SVGIconItems = <
      ...
      item
        ...
        SVGText = 
          ...
          ' viewBox="0 0 48 48"><g fill="none"><path fill="#2F88FF" stroke=' +
          '"#000" stroke-linejoin="round" stroke-width="4" d="M24 44C29.522' +
          '8 44 34.5228 41.7614 38.1421 38.1421C41.7614 34.5228 44 29.5228 ' +
          '44 24C44 18.4772 41.7614 13.4772 38.1421 9.85786C34.5228 6.23858' +
          ' 29.5228 4 24 4C18.4772 4 13.4772 6.23858 9.85786 9.85786C6.2385' +
          '8 13.4772 4 18.4772 4 24C4 29.5228 6.23858 34.5228 9.85786 38.14' +
          '21C13.4772 41.7614 18.4772 44 24 44Z"/><path fill="#fff" fill-ru' +
          'le="evenodd" d="M24 11C25.3807 11 26.5 12.1193 26.5 13.5C26.5 14' +
          '.8807 25.3807 16 24 16C22.6193 16 21.5 14.8807 21.5 13.5C21.5 12' +
          '.1193 22.6193 11 24 11Z" clip-rule="evenodd"/><path stroke="#fff' +
          '" stroke-linecap="round" stroke-linejoin="round" stroke-width="4' +
          '" d="M24.5 34V20H23.5H22.5"/><path stroke="#fff" stroke-linecap=' +
          '"round" stroke-linejoin="round" stroke-width="4" d="M21 34H28"/>' +
          '</g></svg>'
      end>
    Left = 144
    Top = 80
