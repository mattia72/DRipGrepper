unit RipGrepper.UI.Components.CheckBoxComboBox;
...
type
	{ TCustomCheckBoxComboBox }

	TCustomCheckBoxComboBox = class(TComboBox)
		strict private
	...
	TCheckBoxComboBox = class(TCustomCheckBoxComboBox)
		published
			property Align;
			property Anchors;
...
constructor TCustomCheckBoxComboBox.Create(_owner : TComponent);
begin
...
class function TCustomCheckBoxComboBox.withCheckBox() : Boolean;
begin
	Result := True;
end;

class function TCustomCheckBoxComboBox.getCheckBoxClass() : TBoundCheckBoxClass;
begin
	Result := TBoundCheckBox;
end;

procedure TCustomCheckBoxComboBox.CMBidimodechanged(var _message : TMessage);
begin
	inherited;
...
procedure TCustomCheckBoxComboBox.CMEnabledchanged(var _message : TMessage);
begin
	inherited;
	if FCheckBox <> nil then begin
...
procedure TCustomCheckBoxComboBox.CMVisiblechanged(var _message : TMessage);
begin
	inherited;
	if FCheckBox <> nil then begin
...
procedure TCustomCheckBoxComboBox.CMAllChildrenFlipped(var _message : TMessage);
begin
	inherited;
...
procedure TCustomCheckBoxComboBox.Notification(_component : TComponent; _operation : TOperation);
begin
...
procedure TCustomCheckBoxComboBox.SetBounds(_left, _top, _width, _height : Integer);
begin
...
procedure TCustomCheckBoxComboBox.updateCheckBoxPosition();
var
	p : TPoint;
	s : TSize;
	cbSpacing : Integer;
...
procedure TCustomCheckBoxComboBox.setCheckBoxPosition(const _value : TCheckBoxPosition);
begin
...
procedure TCustomCheckBoxComboBox.setCheckBoxSpacing(const _value : Integer);
begin
...
procedure TCustomCheckBoxComboBox.SetName(const _value : TComponentName);
begin
...
procedure TCustomCheckBoxComboBox.SetParent(_parent : TWinControl);
begin
...
procedure TCustomCheckBoxComboBox.setupInternalCheckBox();
begin
...
procedure Register;
begin
	RegisterComponents(SECTION_NAME, [TCheckBoxComboBox]);
end;
