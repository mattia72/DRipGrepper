...
const
	...
	COMPILER_VERSION_DELPHI_11 = 350; // Delphi 11 Alexandria
	COMPILER_VERSION_DELPHI_12 = 360; // Delphi 12.1 Athens
	COMPILER_VERSION_DELPHI_12_1 = 361; // Delphi 12.1 Athens
	COMPILER_VERSION_DELPHI_12_3 = 363; // Delphi 12.3 Athens Update
