...
const
	...
	IMG_IDX_CHECK_ALL_RESULTS = 20;
	IMG_IDX_UNCHECK_ALL_RESULTS = 21;

	IMG_IDX_RESULT_MENU_CHECK_ALL = 5;
	IMG_IDX_RESULT_MENU_UNCHECK_ALL = 6;
	...
	RG_PARAM_REGEX_JSON_OUTPUT = '--json';
	RG_PARAM_REGEX_VIMGREP_OUTPUT = '--vimgrep';
	RG_PARAM_END = '--';
