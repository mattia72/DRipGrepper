...
// Obtain the IOTAEditActions interface for a given module
			class function GxOtaGetEditActionsFromModule(Module: IOTAModule):
				IOTAEditActions;
...
// Module can be nil, if it is , this function will return nil
			class function GxOtaGetFormEditorFromModule(const Module: IOTAModule):
				IOTAFormEditor;
...
uses
	...
	System.StrUtils,
	RipGrepper.Common.Constants, Winapi.Windows;
...
class function IOTAUTils.GxOtaGetEditActionsFromModule(Module: IOTAModule):
	IOTAEditActions;
var
  i: Integer;
  EditView: IOTAEditView;
...
class function IOTAUTils.GxOtaGetFormEditorFromModule(const Module:
...
class function IOTAUTils.GxOtaModuleIsShowingFormSource(Module: IOTAModule):
	Boolean;
var
  Editor: IOTAEditor;
  i: Integer;
