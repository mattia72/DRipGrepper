...
const
	...
	IMG_IDX_FILTER_ON = 28;
	IMG_IDX_FILTER_OFF = 27;
	...
	TREEVIEW_MATCH_TEXT_BGCOLOR = clWebLightBlue;
	TREEVIEW_MATCH_TEXT_STYLE = [fsBold, fsUnderline];

	TREEVIEW_REPLACE_TEXT_COLOR = clMaroon;
	TREEVIEW_REPLACE_TEXT_BGCOLOR = clWebGreenYellow;
	TREEVIEW_REPLACE_TEXT_STYLE = [fsBold];

	TREEVIEW_REPLACED_TEXT_COLOR = clMaroon;
	TREEVIEW_REPLACED_TEXT_BGCOLOR = clWebTomato;
	TREEVIEW_REPLACED_TEXT_STYLE = [fsStrikeOut];
