...
type
  ...
  public
    ...
    class function RunProcess(const _exe: string; _args: TStrings; _handler: INewLineEventHandler): Boolean;
  end;
...
class function TProcessUtils.RunProcess(const _exe: string; _args: TStrings; _handler: INewLineEventHandler): Boolean;
const
  BufSize = 1024;
var
  p: TProcess;
